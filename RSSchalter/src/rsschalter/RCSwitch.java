 ...
 * License as publi
 shed by the Free Software Foundation; either
...
public class RCSwitch {
    ...
    public void LichtAn(String GroupAdrL, int AdressL) {
        BitSet address = RCSwitch.getSwitchGroupAddress(GroupAdrL);
        switchOn(address, AdressL);
        //System.out.println("Test An");

    }

    public void LichtAus(String GroupAdrL, int AdressL) {
        BitSet address = RCSwitch.getSwitchGroupAddress(GroupAdrL);
        switchOff(address, AdressL); //switches the switch unit A off
